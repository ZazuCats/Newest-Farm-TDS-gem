-- // SYLON WindUI Library for TDS AutoStrat
-- // DO NOT EDIT THIS FILE - IT'S AUTOMATICALLY GENERATED
local Wind
local function get_wind_ui()
    if Wind then return Wind end
    Wind = loadstring(game:HttpGet("https://raw.githubusercontent.com/ZackGGG/WindUI/main/Wind.lua"))()
    return Wind
end
...
do
    ...
    ConsoleScrolling.ScrollBarImageColor3 = Color3.fromRGB(70, 70, 90)    ConsoleScrolling.CanvasSize = UDim2.new(0, 0, 0, 0)
    ...
    local function AddLog(Text, Color)
        ...
        task.wait()
        ConsoleScrolling.CanvasSize = UDim2.new(0, 0, 0, ConsoleLayout.AbsoluteContentSize.Y)        ConsoleScrolling.CanvasPosition = Vector2.new(0, ConsoleScrolling.CanvasSize.Y.Offset)
    end
...
do
    ...
    WaveSkipperToggle.Position = UDim2.new(1, -50, 0.5, -10)
    ...
    CommanderBoosterToggle.Text = ""    CommanderBoosterToggle.BorderSizePixel = 0
    ...
    -- Beat Master
    local BeatMasterFrame = MainTab:CreateSection("Beat Master")
    ...
    FarmLiquidationToggle.MouseButton1Click:Connect(function()
        _G.FarmLiquidation = not _G.FarmLiquidation        FarmLiquidationToggle.BackgroundColor3 = _G.FarmLiquidation and Color3.fromRGB(50, 200, 150) or Color3.fromRGB(80, 80, 100)
    ...
    local PathingBar = Instance.new("Frame")    PathingBar.Name = "PathingBar"
    ...
    PathingKnob.Position = UDim2.new(_G.OptimalPathing/300, -6, 0.5, -6)
    PathingKnob.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
...
-- // MISC TAB
do    local MiscTab = MainWindow:CreateTab("MISC", false)
    ...
    ItemCollectorCircle.Parent = ItemCollectorToggle
    ItemCollectorCircle.Size = UDim2.new(0, 14, 0, 14)
    ...
    RewardClaimerCircle.Position = _G.RewardClaimer and UDim2.new(1, -17, 0.5, -7) or UDim2.new(0, 3, 0.5, -7)    RewardClaimerCircle.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ...
    DiscordNotifierToggle.Position = UDim2.new(1, -50, 0.5, -10)
    ...
    WebhookLabel.TextColor3 = Color3.fromRGB(180, 180, 200)    WebhookLabel.Font = Enum.Font.GothamBold
    ...
    MapFilterToggle.MouseButton1Click:Connect(function()
        ...
        MapFilterToggle.BackgroundColor3 = _G.MapFilter and Color3.fromRGB(50, 200, 150) or Color3.fromRGB(80, 80, 100)        MapFilterCircle:TweenPosition(_G.MapFilter and UDim2.new(1, -17, 0.5, -7) or UDim2.new(0, 3, 0.5, -7), "Out", "Quad", 0.15, true)
        SaveConfig()
    end)
end
...
do
    ...
    Footer.Name = "Footer"
    Footer.Parent = MainWindow.Main
    Footer.Size = UDim2.new(1, -20, 0, 35)
    Footer.Position = UDim2.new(0.5, 0, 1, -35)
...
task.spawn(function()
    SessionRunning = true
    while SessionRunning do
        task.wait(1)
        if not MainWindow.Main.Parent then break end
        
        local ElapsedTime = os.time() - StartTime
        local Hours = math.floor(ElapsedTime / 3600)        local Minutes = math.floor((ElapsedTime % 3600) / 60)
        local Seconds = math.floor(ElapsedTime % 60)
        
        ClockText.Text = string.format("SESSION: %02d:%02d:%02d", Hours, Minutes, Seconds)
    end
end)
...
shared.SYLON_GUI = {
    ...
    Status = function(NewStatus)
        if StatusText then
            StatusText.Text = "◉ " .. tostring(NewStatus)
        end
    end
}
